...
[Demo](#-demo) • [Features](#-key-features) • [AI Integration](https://console.deepgram.com) • [Installation](https://cloud.livekit.io/login) • [Architecture](#-architecture) • [API](https://aistudio.google.com/u/1/) • [Contributing](#-contributing)
